...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("crud01DataSet1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class crud01DataSet1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As crud01DataSet1 = CType(MyBase.Clone,crud01DataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "crud01DataSet1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/crud01DataSet1.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As crud01DataSet1 = New crud01DataSet1()
    ...
    Partial Public Class usuarioDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddusuarioRow(ByVal nombre As String, ByVal telefono As String, ByVal direccion As String, ByVal observaciones As String) As usuarioRow
            Dim rowusuarioRow As usuarioRow = CType(Me.NewRow,usuarioRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, telefono, direccion, observaciones}
    ...
    Partial Public Class usuarioRow
        ...
        Public Property observaciones() As String
            Get
                Try 
                    Return CType(Me(Me.tableusuario.observacionesColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'observaciones' de la tabla 'usuario' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableusuario.observacionesColumn) = value
            End Set
        End Property
        ...
        Public Function IsobservacionesNull() As Boolean
            Return Me.IsNull(Me.tableusuario.observacionesColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetobservacionesNull()
            Me(Me.tableusuario.observacionesColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace crud01DataSet1TableAdapters
    ...
    Partial Public Class usuarioTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[usuario] WHERE (([idUsuario] = @Original_idUsuario) AND ((@IsN"& _ 
                ...
                "_direccion)) AND ((@IsNull_observaciones = 1 AND [observaciones] IS NULL) OR ([o"& _ 
                "bservaciones] = @Original_observaciones)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuario] ([nombre], [telefono], [direccion], [observaciones]) "& _ 
                "VALUES (@nombre, @telefono, @direccion, @observaciones);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idUsuario, nomb"& _ 
                "re, telefono, direccion, observaciones FROM usuario WHERE (idUsuario = SCOPE_IDE"& _ 
                "NTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usuario] SET [nombre] = @nombre, [telefono] = @telefono, [direccion"& _ 
                "] = @direccion, [observaciones] = @observaciones WHERE (([idUsuario] = @Original"& _ 
                "_idUsuario) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Origi"& _ 
                "nal_nombre)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] ="& _ 
                " @Original_telefono)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR (["& _ 
                "direccion] = @Original_direccion)) AND ((@IsNull_observaciones = 1 AND [observac"& _ 
                "iones] IS NULL) OR ([observaciones] = @Original_observaciones)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idUsua"& _ 
                "rio, nombre, telefono, direccion, observaciones FROM usuario WHERE (idUsuario = "& _ 
                "@idUsuario)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.usuario.My.MySettings.Default.crud01ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT idUsuario, nombre, telefono, direccion, observaciones FROM dbo.usuario"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As crud01DataSet1.usuarioDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As crud01DataSet1.usuarioDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As crud01DataSet1.usuarioDataTable = New crud01DataSet1.usuarioDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As crud01DataSet1.usuarioDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As crud01DataSet1) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_idUsuario As Integer, ByVal Original_nombre As String, ByVal Original_telefono As String, ByVal Original_direccion As String, ByVal Original_observaciones As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nombre As String, ByVal telefono As String, ByVal direccion As String, ByVal observaciones As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal telefono As String, ByVal direccion As String, ByVal observaciones As String, ByVal Original_idUsuario As Integer, ByVal Original_nombre As String, ByVal Original_telefono As String, ByVal Original_direccion As String, ByVal Original_observaciones As String, ByVal idUsuario As Integer) As Integer
            If (nombre Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal telefono As String, ByVal direccion As String, ByVal observaciones As String, ByVal Original_idUsuario As Integer, ByVal Original_nombre As String, ByVal Original_telefono As String, ByVal Original_direccion As String, ByVal Original_observaciones As String) As Integer
            Return Me.Update(nombre, telefono, direccion, observaciones, Original_idUsuario, Original_nombre, Original_telefono, Original_direccion, Original_observaciones, Original_idUsuario)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As crud01DataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As crud01DataSet1, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._usuarioTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As crud01DataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._usuarioTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As crud01DataSet1) As Integer
